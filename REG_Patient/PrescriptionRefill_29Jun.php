	...
	*/	
	...
	//echo "<h1 color='r\"e\"d'>hahhahah</h1>";
	 ...
	 if(empty($this->bean->id)){
        ...
        echo "<table width='100%'><tr><td  width='65%' style='border-color: rgb( 100, 100, 255); border-style: ridge;border-width: 2px;margin-top: 0;vertical-align: top;'  ><h1>Prescription Refill : ".$this->bean->name." &nbsp;&nbsp; <img src='images.jpg' width='12px'></img> <input type='text' id = 'indication' onblur='set_session(this.id,this.value);'  value='".$value."'> </input></h1> ";
        $this->dv->process();
