...
$metadataFile = $this->getMetaDataFile();
        ...
        $this->dv3->ss =& $this->ss;
		$encounterMetadataFile = 'custom/modules/REG_Encounter/editviewdefs_inpatient.php';
	...
	//echo "<h1 color='r\"e\"d'>hahhahah</h1>";
	 ...
	 if(empty($this->bean->id)){
        ...
        echo "<table ><tr><td  style='border-color: rgb( 100, 100, 255); border-style: ridge;border-width: 2px;margin-top: 0;vertical-align: top;' rowspan='3' width='60%'><h3>Patient Encounter ".$this->bean->name."</h3>";
        $this->dv->process();
       // echo $this->dv->display();
		...
		//Alert Section
		echo "<div id='accordion'><td style='border-color: rgb( 100, 100, 255); border-style: ridge;border-width: 2px;'><h3 style='color:red;'>Alerts</h3><div id='REG_Treatment_Plan_detailview_tabs'><div><div id='detailpanel_1' class='detail view  detail508 '><table id='DEFAULT' class='panelContainer' cellspacing='0' border='1'><tbody><tr>
		<td width='12.5%' scope='col'>1.</td><td  width='77.5%' style='color:red;'>Treatment Plan is not completed yet</td></tr><tr>
		<td width='12.5%' scope='col'>2.</td><td width='77.5%' style='color:red;'>Blood test done on date 19-Dec-2012 was found to contain alchohol above allowed limit</td></tr></tbody></table></div></div></div></td></tr>";
