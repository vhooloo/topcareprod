   ...
   <td valign="top"><table width="100%" cellspacing="0" cellpadding="0" border="1" name="mytable" id="mytable1" class="list view">
     ...
     <tbody>
      ...
      <tr class="oddListRowS1" height="20">
       ...
       <td class="" valign="top" align="left"><input type="checkbox" tabindex="74" id="pulmonary" name="pulmonary" value="1" title="" {php} if($this->get_template_vars('myrisk')->pulmonary == 1) echo "checked='checked'"; {/php} ></td>
      </tr>
      <tr class="oddListRowS1" height="20">
