...
$metadataFile = $this->getMetaDataFile();
	...
	//echo "<h1 color='r\"e\"d'>hahhahah</h1>";
	 ...
	 if(empty($this->bean->id)){
        ...
        echo "<table ><tr><td  style='border-color: rgb( 100, 100, 255); border-style: ridge;border-width: 2px;margin-top: 0;vertical-align: top;' width='65%'><h1>Prescription Refill : ".$this->bean->name."</h1>";
        $this->dv->process();
       // echo $this->dv->display();
		...
		if(($row = $this->bean->db->fetchByAssoc($result) ) != null )
		{
		 ...
		 echo "<script>document.getElementById('date_1').value='".date('m-d-Y',$date1)."'</script>";
		}
		else
		{
		...
		if(($row = $this->bean->db->fetchByAssoc($result) ) != null )
		{
		 ...
		 echo "<script>document.getElementById('date_2').value='".date('m-d-Y',$date2)."'</script>";
		}
		else{
		...
		if(($row = $this->bean->db->fetchByAssoc($result) ) != null )
		{
		 ...
		 echo "<script>document.getElementById('date_3').value='".date('m-d-Y',$date3)."'</script>";
		}
		else{
...
//			echo "<br/>";
				//echo $row['id'].".........".$row['name'];
					...
					if(($count+1)%2==1){
						echo "<tr height=\"20\" class=\"oddListRowS1\"><th scope=\"col\" width=\"20%\"><span sugar=\"slot0\" style=\"white-space:normal;\">".$name[$count]."</span></th><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[0][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[0][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[0][$count]."</span>";}
						echo "</td><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[1][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[1][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[1][$count]."</span>";}
						echo "</td><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[2][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[2][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[2][$count]."</span>";}
						echo "</td><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[3][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[3][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[3][$count]."</span>";}
						echo"</td></tr>";
					}
					else
					{
						echo "<tr height=\"20\" class=\"evenListRowS1\"><th scope=\"col\" width=\"20%\"><span sugar=\"slot0\" style=\"white-space:normal;\">".$name[$count]."</span></th><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[0][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[0][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[0][$count]."</span>";}
						echo "</td><td scope=\"row\" valign=\"top\" class=\"\">";
						if(strtoupper($tmp[1][$count])=='NEG'){ echo "<span sugar=\"slot1b\" style=\"color:red;\">".$tmp[1][$count]."</span>"; } else{ echo"<span sugar=\"slot1b\" >".$tmp[1][$count]."</span>";}
						echo "</td><td scope=\"row\" valign=\"top\" class=\"\">";
