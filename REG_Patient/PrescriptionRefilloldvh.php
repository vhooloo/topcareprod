	...
	*/	
	...
	//echo "<h1 color='r\"e\"d'>hahhahah</h1>";
	 ...
	 if(empty($this->bean->id)){
        ...
        echo "<table width='100%'><tr><td  width='65%' style='border-color: rgb( 100, 100, 255); border-style: ridge;border-width: 2px;margin-top: 0;vertical-align: top;'  ><div><font style='font-size: 18px; font-weight: bold'>Prescription Refill : ".$this->bean->name."  </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Indication for Pain Medication<input type='text' id = 'indication' onblur='set_session(this.id,this.value);'  value='".$value."'> </input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='https://gateway.hhs.state.ma.us/authn/login.do' target='_blank' style='display: inline; text-align: right;'>Link to PMP</a>&nbsp;&nbsp;<img src='images.jpg' width='12px'></img></div>";
