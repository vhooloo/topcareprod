...
<span class="dateTime">
<input class="date_input" tabindex="21" autocomplete="off" type="text" name="nxt_appt_phy_c" id="nxt_appt_phy_c" onchange='check_date(this);' value="" title=""  size="11" maxlength="10">
...
<span class="dateTime">
<input class="date_input" tabindex="22" autocomplete="off" type="text" name="nxt_appt_behav_c" id="nxt_appt_behav_c" onchange='check_date(this);' value="" title=""  size="11" maxlength="10">
...
<input type="text" tabindex="23" name="next_appt_other_c" id="next_appt_other_c" size="22" maxlength="20" value="" title="">
</td>
</tr>
