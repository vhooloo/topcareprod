...
Next Rx Refill <br> 
<span class="dateTime">
<input class="date_input" autocomplete="off" tabindex="4" type="text" name="next_rx_refill_due_c" id="next_rx_refill_due_c" value="" title="" size="11" maxlength="10">
...
<td style="width:33.3%;">
Next UTS due <br>
<pre style="margin-top:0; margin-bottom:0;"><span class="dateTime"><input  class="date_input" autocomplete="off" tabindex="5" type="text" name="next_uts_due_c" id="next_uts_due_c" value="" title=""  size="10" maxlength="10"><img src="themes/Sugar5/images/jscalendar.gif?v=GogGz9QEok1-e0Ft6rexxQ" alt="Enter Date" style="position:relative; top:6px" border="0" id="next_uts_due_c_trigger"></span>{literal}<script type="text/javascript">
Calendar.setup ({
...
<span id="description_row" style="width:80px;display:none;" ><br>
...
<td  width="66.6%" ><br>Encounter Summary <input type="text"  tabindex="11" name="summary" id="summary" size="22" maxlength="255" value="" title=""  onblur="set_session(this.id,this.value);">
</td>
...
<input class="date_input" autocomplete="off" type="text" name="last_pcp_visit_c" id="last_pcp_visit_c" value="" title=""  size="11" maxlength="10">&thinsp;<img src="themes/Sugar5/images/jscalendar.gif?v=GogGz9QEok1-e0Ft6rexxQ" alt="Enter Date" style="position:relative; top:6px" border="0" id="last_pcp_visit_c_trigger"> </pre>
</span>
{literal}
<script type="text/javascript">
Calendar.setup ({
...
<span class="dateTime">
<input class="date_input" autocomplete="off" type="text" name="nxt_appt_pain_c" id="nxt_appt_pain_c" value="" title=""  size="10" maxlength="10">
...
<span class="dateTime">
<input class="date_input" autocomplete="off" type="text" name="nxt_appt_phy_c" id="nxt_appt_phy_c" value="" title=""  size="11" maxlength="10">
...
<span class="dateTime">
<input class="date_input" autocomplete="off" type="text" name="last_rx_signed_md_c" id="last_rx_signed_md_c" value="" title=""  size="11" maxlength="10">
...
<span class="dateTime">
<input class="date_input" autocomplete="off" type="text" name="nxt_appt_behav_c" id="nxt_appt_behav_c" value="" title=""  size="11" maxlength="10">
...
<span class="dateTime">
<input class="date_input" autocomplete="off" type="text" name="last_rx_pickup_pt_c"  id="last_rx_pickup_pt_c" value="" title=""  size="11" maxlength="10">
...
&nbsp;Next PCP visit <br>
<span class="dateTime"><pre style="margin-top:0; margin-bottom:0;">
<input class="date_input" autocomplete="off" type="text" name="next_pcp_visit_c" id="next_pcp_visit_c" value="" title=""  size="11" maxlength="10">&thinsp;<img src="themes/Sugar5/images/jscalendar.gif?v=GogGz9QEok1-e0Ft6rexxQ" alt="Enter Date" style="position:relative; top:6px" border="0" id="next_pcp_visit_c_trigger"></pre>
</span>
{literal}
<script type="text/javascript">
Calendar.setup ({
...
<table style="width:100%;border-color: rgb( 100, 100, 255); border-style: solid none none none; border-width: 2px; margin-top: 0;vertical-align: top;">
<tr>
<td><h3><span style="text-align:centre;" >Administrative</span></h3></td>
</tr>

<tr>
<td >
<input type="hidden" name="pt_confirms_storing_c" value="0"><input type="checkbox" id="pt_confirms_storing_c" name="pt_confirms_storing_c"  value="1" title=""   > Patient confirms storing medications safely
</td>
</tr>
<tr>
<td ><br>
<input type="hidden" name="narcotic_contract_in_chart_c" value="0"><input type="checkbox" tabindex="15" id="narcotic_contract_in_chart_c" name="narcotic_contract_in_chart_c" value="1" title=""   > <span> Narcotic contract in chart & contract signed on </span><span class="dateTime"> <input tabindex="14" class="date_input" autocomplete="off" type="text" name="narcotic_contract_sign_c" id="narcotic_contract_sign_c"   value="" title=""  size="10" maxlength="10">
...
<input type="checkbox" id="pt_confirms_taking_c" name="pt_confirms_taking_c" value="1" title=""   > Patient confirms taking medications as prescribed
